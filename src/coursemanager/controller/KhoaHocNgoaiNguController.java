...
import coursemanager.repository.KhoaHocNgoaiNguRepository;
import coursemanager.service.IKhoaHocService;
import coursemanager.service.KhoaHocNgoaiNguService;

import java.util.List;
import java.util.Scanner;

public class KhoaHocNgoaiNguController {
    private final Scanner sc = new Scanner(System.in);
    private final IKhoaHocService<KhoaHocNgoaiNguEntity> service =
            new KhoaHocNgoaiNguService(new KhoaHocNgoaiNguRepository());
    ...
    public void menuNgoaiNgu() {
        while (true) {
            ...
            switch (c) {
                case "1":
                    List<KhoaHocNgoaiNguEntity> list = service.getAll();
                ...
                case "2":
                    try {
                        ...
                        System.out.print("Ngôn ngữ giảng dạy: "); String lang = sc.nextLine().trim();
                        System.out.print("Cấp độ (A1/A2/B1/B2/C1/C2...): "); String level = sc.nextLine().trim();
                        service.add(new KhoaHocNgoaiNguEntity(ma, ten, gv, hp, lang, level));
